...
const Sidebar = ({ isOpen }) => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: LayoutDashboard, path: '/dashboard', roles: ['admin', 'employee', 'executive'] },
    ...
    { name: 'Meetings', icon: Group, path: '/meetings', roles: ['admin','executive',"employee","manager",] },
