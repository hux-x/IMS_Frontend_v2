// components/cards/ProjectList.js
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {projects.map(project => (
        <div 
          key={project._id} // Changed from id to _id (MongoDB uses _id)
        ...
        >
          {project.projectImages?.length > 0 && ( // Changed from images to projectImages
            <div className="h-48 relative">
              <img 
                src={project.projectImages[0]} // Direct URL, not Blob URL
          ...
          <div className="p-5">
            <div className="flex justify-between items-start">
              <h3 className="text-lg font-bold text-gray-800">{project.projectTitle}</h3> {/* Changed from title */}
            ...
            <div className="mt-4 flex justify-between items-center">
              ...
              <div className="flex space-x-2">
                ...
                <button 
                  onClick={(e) => {
                    e.stopPropagation();
                    onDelete(project._id); // Changed from id to _id
                  }}
