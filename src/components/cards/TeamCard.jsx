...
import { FaCrown, FaUserCircle, FaUsers, FaEllipsisV } from 'react-icons/fa'; // Added FaEllipsisV for potential future menu
...
const TeamCard = ({ team, onClick }) => {
    ...
    const membersToShow = team.members.slice(0, 3); // Show up to 3 members for small avatars
    const remainingMembers = team.members.length - membersToShow.length;
        ...
        >
            <div className="flex justify-between items-start mb-4">
                <div
                    ...
                    style={{ backgroundColor: team.color || '#4A90E2' }} // Default color if not provided
                >
            ...
            <div className="text-xs text-gray-500 mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
                ...
                {/* Optional: Add an ellipsis icon for a dropdown menu if needed */}
                {/* <FaEllipsisV className="text-gray-400 hover:text-gray-600 transition duration-150" /> */}
            </div>
        </div>
    );
};
